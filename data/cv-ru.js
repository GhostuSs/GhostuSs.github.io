window.CV_DATA_RU = {
      ...
      projects: [
        {
          ...
          bullets: [
            ...
            "Финалист премий REXA-2025 и «Люди прогресса» — премии инноваций «Газпром нефти».",
  ...
  achievements: {
    ...
    recognition: {
      ...
      items: [
        "Финалист REXA-2025 — премия инноваций «Газпром нефти»",
        "Финалист премии «Люди прогресса»",
        "Гран-при IT Camp 2025 — менторская команда"
      ]
    },
    opensource: {
